...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-excluded-packages '(flycheck-ocaml merlin ocp-indent)
...
you should place your code here."
  ...
  (dotspacemacs/lsp-config)
  (dotspacemacs/ocaml-config)
  (dotspacemacs/org-roam-config)

  ;; Kill/yank whole line when no region is selected.
  ...
  (defun my-org-mode-hook ()
    (key-chord-define org-mode-map "--" 'org-meta-return))
  (add-hook 'org-mode-hook 'my-org-mode-hook)

  (define-key spacemacs-latex-mode-map-prefix (kbd "RET") 'latex-insert-item)
...
(custom-set-variables
 ...
 '(exec-path
   '("/home/feser/.opam/4.10.0/bin" "/home/feser/.local/bin" "/usr/local/sbin" "/usr/local/bin" "/usr/sbin" "/usr/bin" "/sbin" "/bin" "/usr/games" "/usr/local/games" "/snap/bin" "/snap/emacs/current/usr/libexec/emacs/27.0.91/x86_64-pc-linux-gnu"))
 ...
 '(helm-boring-file-regexp-list
   '("\\.DS_Store$" "\\.fls$" "\\.vrb$" "\\.pdf$" "\\.gz$" "\\.snm$" "\\.out$" "\\.nav$" "\\.cmxs$" "\\.cmti$" "\\.cmt$" "\\.annot$" "\\.cmi$" "\\.cmxa$" "\\.cma$" "\\.cmx$" "\\.cmo$" "\\.pho$" "\\.phi$" "\\.glob$" "\\.vo$" "\\.hi$" "\\.o$" "~$" "\\.bin$" "\\.lbin$" "\\.so$" "\\.a$" "\\.ln$" "\\.blg$" "\\.bbl$" "\\.elc$" "\\.lof$" "\\.glo$" "\\.idx$" "\\.lot$" "\\.svn\\(/\\|$\\)" "\\.hg\\(/\\|$\\)" "\\.git\\(/\\|$\\)" "\\.bzr\\(/\\|$\\)" "CVS\\(/\\|$\\)" "_darcs\\(/\\|$\\)" "_MTN\\(/\\|$\\)" "\\.fmt$" "\\.tfm$" "\\.class$" "\\.fas$" "\\.lib$" "\\.mem$" "\\.x86f$" "\\.sparcf$" "\\.dfsl$" "\\.pfsl$" "\\.d64fsl$" "\\.p64fsl$" "\\.lx64fsl$" "\\.lx32fsl$" "\\.dx64fsl$" "\\.dx32fsl$" "\\.fx64fsl$" "\\.fx32fsl$" "\\.sx64fsl$" "\\.sx32fsl$" "\\.wx64fsl$" "\\.wx32fsl$" "\\.fasl$" "\\.ufsl$" "\\.fsl$" "\\.dxl$" "\\.lo$" "\\.la$" "\\.gmo$" "\\.mo$" "\\.toc$" "\\.aux$" "\\.cp$" "\\.fn$" "\\.ky$" "\\.pg$" "\\.tp$" "\\.vr$" "\\.cps$" "\\.fns$" "\\.kys$" "\\.pgs$" "\\.tps$" "\\.vrs$" "\\.pyc$" "\\.pyo$"))
 ...
 '(safe-local-variable-values
   '((eval lsp-register-client
     ...
     (eval setq merlin-command
           (concat project-path "scripts/ocamlmerlin"))
     (eval set
           (make-local-variable 'project-path)
           (file-name-directory
            (let
